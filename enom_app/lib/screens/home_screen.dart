      ...
      child: Column(
        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              _buildQuickAction(Icons.shopping_bag_outlined, 'Shop'),
              _buildQuickAction(Icons.favorite_outline, 'Wishlist'),
              _buildQuickAction(Icons.local_offer_outlined, 'Offers'),
